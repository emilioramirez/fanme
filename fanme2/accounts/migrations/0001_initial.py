...
class Migration(SchemaMigration):
    ...
    models = {
        'accounts.profilebase': {
            'Meta': {'object_name': 'ProfileBase'},
            'avatar': ('django.db.models.fields.files.ImageField', [], {'default': "'default.jpg'", 'max_length': '100'}),
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'profilebase'", 'unique': 'True', 'to': "orm['auth.User']"})
        },
        'auth.group': {
