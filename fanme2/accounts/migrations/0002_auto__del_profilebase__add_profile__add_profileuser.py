...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_profileuser', (
            ('profile_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.Profile'], unique=True, primary_key=True)),
            ('birthday', self.gf('django.db.models.fields.DateField')()),
            ('sex', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('accounts', ['ProfileUser'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('accounts_profileuser')
    ...
    models = {
        ...
        'accounts.profileuser': {
            'Meta': {'object_name': 'ProfileUser', '_ormbases': ['accounts.Profile']},
            'birthday': ('django.db.models.fields.DateField', [], {}),
            'profile_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['accounts.Profile']", 'unique': 'True', 'primary_key': 'True'}),
