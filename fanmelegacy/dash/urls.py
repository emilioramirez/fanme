...
urlpatterns = patterns('',
    ...
    url(r'^fans/', views.my_fans_items, name="my_fans_items"),
    url(r'^comments/$', views.my_comments_items, name="my_comments_items"),
    url(r'^recomendated/$', views.recomendaciones_enviadas, name="recomendaciones_enviadas"),
    url(r'^recomendation/$', views.recomendaciones_recibidas, name="recomendaciones_recibidas"),
