...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Empresa.direccion'
        db.add_column(u'accounts_empresa', 'direccion',
                      self.gf('django.db.models.fields.CharField')(default='Sin direccion', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Empresa.direccion'
        db.delete_column(u'accounts_empresa', 'direccion')
    ...
    models = {
        u'accounts.empresa': {
            ...
            'direccion': ('django.db.models.fields.CharField', [], {'default': "'Sin direccion'", 'max_length': '40'}),
