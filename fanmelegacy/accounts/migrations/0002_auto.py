...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field items on 'Persona'
        db.create_table('accounts_persona_items', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('persona', models.ForeignKey(orm['accounts.persona'], null=False)),
            ('item', models.ForeignKey(orm['items.item'], null=False))
        ))
        db.create_unique('accounts_persona_items', ['persona_id', 'item_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field items on 'Persona'
        db.delete_table('accounts_persona_items')
