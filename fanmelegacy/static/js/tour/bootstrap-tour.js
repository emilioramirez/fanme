    ...
    Tour = (function() {
      function Tour(options) {
        this._options = $.extend({
          ...
          orphan: false,
          basePath: "",
          template: "<div class='popover'>          <div class='arrow'></div>          <h3 class='popover-title'></h3>          <div class='popover-content'></div>          <nav class='popover-navigation'>            <div class='btn-group'>              <button class='btn btn-sm btn-default' data-role='prev'>&laquo; Ant.</button>              <button class='btn btn-sm btn-default' data-role='next'>Sig. &raquo;</button>            </div>            <button class='btn btn-sm btn-default' data-role='end'>Terminar tour</button>          </nav>        </div>",
