...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('items_recomendacion', (
        ...
        db.send_create_signal('items', ['Recomendacion'])


    def backwards(self, orm):
        
        # Deleting model 'Recomendacion'
        db.delete_table('items_recomendacion')
    ...
    models = {
        ...
        'items.item': {
            ...
            'users_recomendation': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'recomendations'", 'symmetrical': 'False', 'through': "orm['items.Recomendacion']", 'to': "orm['auth.User']"})
        },
        'items.marca': {
