...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recomendacion.user_origen'
        db.alter_column('items_recomendacion', 'user_origen_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Recomendacion.user_origen'
        db.alter_column('items_recomendacion', 'user_origen_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['items.Recomendaciones']))
