...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('social_evento', 'descripcion', self.gf('django.db.models.fields.TextField')(default='', max_length=300), keep_default=False)

        # Adding field 'Evento.fecha_inicio'
        db.add_column('social_evento', 'fecha_inicio', self.gf('django.db.models.fields.DateTimeField')(default=''), keep_default=False)

        # Adding field 'Evento.fecha_fin'
        db.add_column('social_evento', 'fecha_fin', self.gf('django.db.models.fields.DateTimeField')(default=''), keep_default=False)

        # Adding field 'Evento.fecha_creacion'
        db.add_column('social_evento', 'fecha_creacion', self.gf('django.db.models.fields.DateTimeField')(default=''), keep_default=False)

        # Adding field 'Evento.localizacion'
        db.add_column('social_evento', 'localizacion', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['support.Localizacion']), keep_default=False)
