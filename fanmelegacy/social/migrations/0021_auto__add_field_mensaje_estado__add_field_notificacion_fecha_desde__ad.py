...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mensaje.estado'
        db.add_column('social_mensaje', 'estado', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'Notificacion.fecha_desde'
        db.add_column('social_notificacion', 'fecha_desde', self.gf('django.db.models.fields.DateTimeField')(default=''), keep_default=False)

        # Adding field 'Notificacion.estado'
        db.add_column('social_notificacion', 'estado', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'Evento.estado'
        db.add_column('social_evento', 'estado', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Mensaje.estado'
        db.delete_column('social_mensaje', 'estado')

        # Deleting field 'Notificacion.fecha_desde'
        db.delete_column('social_notificacion', 'fecha_desde')

        # Deleting field 'Notificacion.estado'
        db.delete_column('social_notificacion', 'estado')

        # Deleting field 'Evento.estado'
        db.delete_column('social_evento', 'estado')
