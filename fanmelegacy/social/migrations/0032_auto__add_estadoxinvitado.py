...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EstadoxInvitado'
        db.create_table(u'social_estadoxinvitado', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('evento', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['social.Evento'], null=True, blank=True)),
            ('estado', self.gf('django.db.models.fields.CharField')(default='noleido', max_length=30)),
        ))
        db.send_create_signal(u'social', ['EstadoxInvitado'])
    ...
    def backwards(self, orm):
        # Deleting model 'EstadoxInvitado'
        db.delete_table(u'social_estadoxinvitado')
