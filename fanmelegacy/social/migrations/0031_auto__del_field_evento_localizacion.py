...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'social_evento', 'localizacion_id')


    def backwards(self, orm):
        # Adding field 'Evento.localizacion'
        db.add_column(u'social_evento', 'localizacion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['support.Localizacion']),
                      keep_default=False)
