...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Actividad.comentario_new'
        db.add_column(u'social_actividad', 'comentario_new',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='act_coment', null=True, blank=True, to=orm['comments.Comment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Actividad.comentario_new'
        db.delete_column(u'social_actividad', 'comentario_new_id')
    ...
    models = {
        ...
        u'social.actividad': {
            ...
            'comentario_new': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'act_coment'", 'null': 'True', 'blank': 'True', 'to': u"orm['comments.Comment']"}),
