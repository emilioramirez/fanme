...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'social_evento', 'fecha_fin', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Evento.fecha_inicio'
        db.alter_column(u'social_evento', 'fecha_inicio', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Evento.fecha_fin'
        db.alter_column(u'social_evento', 'fecha_fin', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Evento.fecha_inicio'
        db.alter_column(u'social_evento', 'fecha_inicio', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'social.estadoxinvitado': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitado': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'invitaciones_eventos'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"})
        },
        u'social.evento': {
