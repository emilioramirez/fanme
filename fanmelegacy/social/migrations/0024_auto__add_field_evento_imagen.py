...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Evento.imagen'
        db.add_column('social_evento', 'imagen', self.gf('django.db.models.fields.files.ImageField')(default='images/calendario-default.png', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Evento.imagen'
        db.delete_column('social_evento', 'imagen')
