...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('social_consulta', 'item', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='mis_consultas', to=orm['items.Item']), keep_default=False)
