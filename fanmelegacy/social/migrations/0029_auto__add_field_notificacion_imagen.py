...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notificacion.imagen'
        db.add_column(u'social_notificacion', 'imagen',
                      self.gf('django.db.models.fields.files.ImageField')(default='images/calendario-default.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notificacion.imagen'
        db.delete_column(u'social_notificacion', 'imagen')
