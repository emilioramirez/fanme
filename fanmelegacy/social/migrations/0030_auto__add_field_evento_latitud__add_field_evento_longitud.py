...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evento.latitud'
        db.add_column(u'social_evento', 'latitud',
                      self.gf('django.db.models.fields.CharField')(default='0.0', max_length=30),
                      keep_default=False)

        # Adding field 'Evento.longitud'
        db.add_column(u'social_evento', 'longitud',
                      self.gf('django.db.models.fields.CharField')(default='0.0', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evento.latitud'
        db.delete_column(u'social_evento', 'latitud')

        # Deleting field 'Evento.longitud'
        db.delete_column(u'social_evento', 'longitud')
    ...
    models = {
        ...
        u'social.evento': {
            ...
            'localizacion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['support.Localizacion']"}),
        ...
        u'support.localidad': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'provincia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['support.Provincia']"})
        },
        u'support.localizacion': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'localidad': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['support.Localidad']"}),
        ...
        u'support.provincia': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'pais': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['support.Pais']"})
        }
    }
