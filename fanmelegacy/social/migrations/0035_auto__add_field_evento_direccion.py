...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evento.direccion'
        db.add_column(u'social_evento', 'direccion',
                      self.gf('django.db.models.fields.CharField')(default='direccion', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evento.direccion'
        db.delete_column(u'social_evento', 'direccion')
