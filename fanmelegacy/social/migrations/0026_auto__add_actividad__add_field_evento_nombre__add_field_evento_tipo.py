...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_actividad', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='act_item', null=True, blank=True, to=orm['items.Item'])),
            ('recomendacion', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='act_recom', null=True, blank=True, to=orm['items.Recomendacion'])),
            ('comentario', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='act_coment', null=True, blank=True, to=orm['items.Comentario'])),
        ...
        db.send_create_signal('social', ['Actividad'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('social_actividad')
