...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_eventos', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creador', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('social', ['Eventos'])

        # Adding field 'Evento.creador'
        db.add_column('social_evento', 'creador', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['social.Eventos']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Eventos'
        db.delete_table('social_eventos')

        # Deleting field 'Evento.creador'
        db.delete_column('social_evento', 'creador_id')
    ...
    models = {
        ...
        'social.evento': {
            ...
            'creador': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['social.Eventos']"}),
