...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evento.fecha_creacion'
        db.alter_column('social_evento', 'fecha_creacion', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Evento.fecha_fin'
        db.alter_column('social_evento', 'fecha_fin', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Evento.fecha_inicio'
        db.alter_column('social_evento', 'fecha_inicio', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'Evento.fecha_creacion'
        db.alter_column('social_evento', 'fecha_creacion', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Evento.fecha_fin'
        db.alter_column('social_evento', 'fecha_fin', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Evento.fecha_inicio'
        db.alter_column('social_evento', 'fecha_inicio', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'social.eventos': {
            ...
            'creador': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'social.mensaje': {
