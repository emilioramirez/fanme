...
urlpatterns = patterns('',
    ...
    (r'^notifications_by_company_ayuda/', views.notification_by_company_ayuda),
    (r'^nuevo/$', views.new_evento),
    (r'^user_main_notification/$', views.user_main_view_notifications),
    (r'^user_main_notification_ayuda/$', views.user_main_view_notifications_ayuda),
    ...
    (r'^ver_notificaciones_ayuda/', views.ver_notificacion_ayuda),
