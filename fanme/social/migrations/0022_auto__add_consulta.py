...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_consulta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consultas_recibidos', to=orm['auth.User'])),
            ('user_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consultas_enviados', to=orm['auth.User'])),
        ...
        db.send_create_signal('social', ['Consulta'])


    def backwards(self, orm):
        
        # Deleting model 'Consulta'
        db.delete_table('social_consulta')
