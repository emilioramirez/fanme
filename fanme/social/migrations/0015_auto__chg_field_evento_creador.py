...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evento.creador'
        db.alter_column('social_evento', 'creador_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Evento.creador'
        db.alter_column('social_evento', 'creador_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social.Eventos']))
