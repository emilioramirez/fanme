...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('social_consulta', 'item', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='consultas', to=orm['items.Item']), keep_default=False)
    ...
    models = {
        ...
        'social.consulta': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'consultas'", 'to': "orm['items.Item']"}),
