...
dhtmlXCalendarObject.prototype.langData = {
    "en": {
        ...
        daysFNames: ["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Sunday"],
        daysSNames: ["Su","Mo","Tu","We","Thu","Fri","Sa"],
        weekstart: 1
    }
};
...
dhtmlXCalendarObject.prototype.langData = {
    "esp": {
        ...
        daysFNames: ["Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sàbado"],
        daysSNames: ["Dom","Lun","Mar","Miér","Jue","Vie","Sab"],
        weekstart: 1
    }
};
