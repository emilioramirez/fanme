...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recomendacion.estado'
        db.add_column('items_recomendacion', 'estado', self.gf('django.db.models.fields.CharField')(default='noleido', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Recomendacion.estado'
        db.delete_column('items_recomendacion', 'estado')
    ...
    models = {
        ...
        'items.itemimagen': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagen': ('django.db.models.fields.files.ImageField', [], {'default': "'items/default.png'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mis_imagenes'", 'to': "orm['items.Item']"})
        },
        'items.marca': {
