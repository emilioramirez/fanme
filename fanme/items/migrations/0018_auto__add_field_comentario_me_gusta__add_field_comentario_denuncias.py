...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comentario.me_gusta'
        db.add_column('items_comentario', 'me_gusta', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Comentario.denuncias'
        db.add_column('items_comentario', 'denuncias', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comentario.me_gusta'
        db.delete_column('items_comentario', 'me_gusta')

        # Deleting field 'Comentario.denuncias'
        db.delete_column('items_comentario', 'denuncias')
