...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comentario.user'
        db.add_column('items_comentario', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comentario.user'
        db.delete_column('items_comentario', 'user_id')
