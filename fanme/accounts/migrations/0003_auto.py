...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field following on 'Persona'
        db.create_table('accounts_persona_following', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('persona', models.ForeignKey(orm['accounts.persona'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('accounts_persona_following', ['persona_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field following on 'Persona'
        db.delete_table('accounts_persona_following')
