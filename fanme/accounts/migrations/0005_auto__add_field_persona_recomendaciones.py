...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Persona.recomendaciones'
        db.add_column('accounts_persona', 'recomendaciones', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['items.Recomendacion'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Persona.recomendaciones'
        db.delete_column('accounts_persona', 'recomendaciones_id')
    ...
    models = {
        ...
        'accounts.persona': {
            ...
            'recomendaciones': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['items.Recomendacion']", 'null': 'True', 'blank': 'True'}),
        ...
        'items.item': {
            ...
            'users_recomendation': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'me_recomendaron'", 'symmetrical': 'False', 'through': "orm['items.Recomendacion']", 'to': "orm['auth.User']"})
        },
        'items.recomendacion': {
