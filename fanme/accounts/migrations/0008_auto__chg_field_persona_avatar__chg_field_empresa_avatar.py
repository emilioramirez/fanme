...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('accounts_persona', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Empresa.avatar'
        db.alter_column('accounts_empresa', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Persona.avatar'
        db.alter_column('accounts_persona', 'avatar', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))

        # Changing field 'Empresa.avatar'
        db.alter_column('accounts_empresa', 'avatar', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))


    models = {
        'accounts.empresa': {
            'Meta': {'object_name': 'Empresa'},
            'avatar': ('django.db.models.fields.files.ImageField', [], {'default': "'avatares/default.png'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
